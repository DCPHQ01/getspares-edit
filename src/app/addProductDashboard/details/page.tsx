                        ...
                        <div className="flex gap-x-10 justify-between">
                            <div className="flex flex-col gap-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        <option id={`condition`} value="" disabled selected>Condition</option>
                                    ...
                                    <div className="inputImage imagetext  h-[283px] w-[25.1rem]">
                                        {images && images.length > 0 ? (
                                            <div className="relative flex justify-center">
                                                ...
                                                <div
                                                    className="absolute w-[84%] h-full space-x-4 flex justify-between items-center mt-4">
                                                    <button
                                                        type="button"
                                                        title="icon button"
                                            ...
                                            <div className="flex flex-col items-center justify-center">
                                                <div
                                                    className="border rounded-full mt-20 h-32 w-32 flex justify-center">
                                                    <div
                                                        id="prevImgState"
