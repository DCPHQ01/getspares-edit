...
function Index() {
    ...
    const DropdownMenu = () => {
        return (
            <div className={`absolute mt-2 w-[17rem] p-1 shadow-[0_2px_8px_0_rgba(0,0,0,0.2)] rounded-[8px] bg-white`}>
                ...
                <div className={`mx-3 flex justify-between my-[1rem]`}>
                    <button className={`border border-[#095AD3] text-[#095AD3] py-[0.4rem] px-[1.5rem] rounded-full`}>Reset</button>
                    <button className={`bg-[#095AD3] text-white py-[0.4rem] px-[1.5rem] rounded-full`}>Apply</button>
                </div>
            </div>
        );
    };
