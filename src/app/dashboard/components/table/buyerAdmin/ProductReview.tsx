...
const ProductReview = () => {
    ...
    const [openViewAllCommentsModal, setOpenViewAllCommentsModal] = React.useState<boolean>(false);
        ...
        <div>
            ...
            <div className={`flex gap-16 mt-4`}>
                ...
                <div className={`w-[600px] h-[436px]`}>
                    ...
                    <div onClick={handleOpenViewAllCommentsModal} className={`underline text-[#095AD3] cursor-pointer`}>View more comments</div>
                </div>
            </div>
            <ReviewModal openModal={openModal} setOpenModal={setOpenModal} />
            <ViewAllComments openModal={openViewAllCommentsModal} setOpenModal={setOpenViewAllCommentsModal} />
