    ...
    return (
        <>
            <div id="welcomeSection" className={`flex justify-between items-center`}>
                <div>
                    <h1 id="welcomeTitle" className={`font-semibold text-[1.9rem] text-[#101828]`}>Welcome Back, Sam</h1>
                    <p id="welcomeText" className={`text-[#364152]`}>Take a quick glance on what is happening with meca</p>
                </div>
                <div>
                    {role === roles.VENDOR_ADMIN &&
                        (<button id="addCompanyButton" className={`bg-[#095AD3] text-white rounded-full py-[0.38rem] px-[1.5rem]`}>
                                Add Company
                            </button>
                        )
                    }
            ...
            <div id="sectionHeader" className={`mt-[3.25rem] flex justify-between`}>
                <div>
                    <p id="headerTitle" className={`font-semibold text-[1.25rem]`}>{header}</p>
                    <p id="subheaderText" className={`text-[#364152]`}>{subheader}</p>
                </div>
                <div>
                    <PeriodRadios/>
                </div>
